...
} ( function ( $, window, document, undefined )
{
	...
	var
		...
		defaults           = {
			...
			/**
			 * A function that can be used to alter the state object before it is updated or added to the browsers
			 * history
		...
		utility            = {
			...
			shouldLoadAnchor : function ( $anchor, blacklist, hrefRegex )
			{
				...
				// blacklisted
				return (
					   ! utility.isExternal ( href ) && ! utility.isHash ( href ) && ! $anchor.is ( blacklist ) && ! $anchor.prop ( 'target' )) &&
					   (
