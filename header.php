...
<head>
    <link href='https://fonts.googleapis.com/css?family=Roboto:400,400italic,500italic,500' rel='stylesheet'
          type='text/css'>
...
<div id="shade"></div>
<div class="loading">
    <img data-layzr="<?php echo get_template_directory_uri (); ?>/assets/images/sys-logo-blob.png" height="57"
         width="55" alt="SYS Logo Circle Only">
</div>
